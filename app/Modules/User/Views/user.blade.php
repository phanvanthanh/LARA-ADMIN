...
@section('content')
	<div class="col-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                  <div class="col-6">
                    <h4 class="text-danger">QUẢN LÝ TÀI KHOẢN</h4>
                  </div>
                    <div class="col-6">
                ...
                <div class="text-right table-responsive">
                    <div class="btn-group mr-2">
                        <button class="btn btn-sm btn-vnpt btn-load-form-them-moi" data-toggle="modal" data-target="#modal-them-moi"><i class="mdi mdi-plus-circle-outline"></i> Thêm tài khoản</button>
                    </div>
                </div>
                <br>
         ...
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                  ...
                  <button type="button" class="btn btn-light" data-dismiss="modal">Không lưu</button>
               </div>
            </div>
         </div>
      </div>
  ...
  <script type="text/javascript">
    jQuery(document).ready(function() {
      ...
      loadTable(_token, "{{ route('danh-sach-user') }}", '.load-danh-sach');

      $('.btn-them-moi').on('click',function(){
          themMoi(_token, $("form#frm-them-moi"), "{{ route('them-user') }}", "{{ route('danh-sach-user') }}", '.load-danh-sach');
